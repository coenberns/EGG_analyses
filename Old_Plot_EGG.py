...
def egg_signalfreq(dat,rate=62.5,freqlim=[1,10],ylim=0,mode='power',ylog=False,xlog=False,clip=False,labels=[],figsize=(10,20),vline=[],vline_color='black',textsize=12,title='',name_dict={}):
    '''
...
#        ax[i-1].autoscale(axis='y')
    ...
    ax[dat.shape[1]-2].set_title(title)
